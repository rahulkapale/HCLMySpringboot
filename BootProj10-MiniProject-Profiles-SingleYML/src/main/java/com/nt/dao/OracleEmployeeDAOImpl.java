...
import com.nt.BootProj10MiniProjectLayeredApplication;
...
public class OracleEmployeeDAOImpl implements IEmployeeDAO {
	...
	private static final String GET_EMP_BY_DESGS = 
			  "SELECT ENO, ENAME, DESG, SALARY FROM EMP_PROFILE " +
			  "WHERE TRIM(UPPER(DESG)) IN (?, ?, ?) ORDER BY DESG";
	...
	public OracleEmployeeDAOImpl() {
		System.out.println("OracleEmployeeDAOImpl::0-param constrctor");
	}
	...
	public List<Employee> getEmpsByDesgs(String desg1, String desg2, String desg3) throws Exception {
	    ...
	    System.out.println("Input designations: " + desg1 + ", " + desg2 + ", " + desg3);
